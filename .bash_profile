...
run() {
    thanx-cli platform run rails c -c "thanx-$1" -p "$2"
}
...
alias finish="~/dev/python/finish.py"
...
alias rebase_quick="git fetch; git rebase origin/dev -i"
alias scd="z.sh"
alias nuc="j \`bundle list nucleus\`"
...
alias less="less -N"
alias new="git checkout origin/dev -q; git checkout -b"
...
alias merchant-api="cd ~/dev/thanx-merchant-api"
alias merchant-api-new="cd ~/dev/thanx-merchant-api-new"
